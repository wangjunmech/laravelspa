...
<button id="startRecordingButton" class="btn btn-primary" @click="startRec">开始录音</button>
<button id="stopRecordingButton" class="btn btn-primary" @click="stopRec">停止录音</button>
<button id="playButton" class="btn btn-primary" @click="playRec">播放录音</button>
<button id="downloadButton" class="btn btn-primary" @click="downRec">下载录音</button>
        <div id="info"></div>
</div>
   </div>
  </div>
