...
class ToolsController extends Controller
{
    ...
    {
        // return 'PHP version'.substr(PHP_VERSION,0,3).' / Full Version'. PHP_VERSION;
        // $Excel=new Excel();
        // $file = './excel/too number list.xlsx';
        // $exts = (pathinfo($file)['extension']);//用phpinfo获取文件扩展名
        // $Excel->Importexcel($file, function($reader){
    ...
    // $data = Excel::import(new ToolImport, './excel/too number list.xlsx');//仅限路径测试
  // $data = Excel::import(new ToolImport, './excel/too number list.xlsx');
  $data = Excel::import(new ToolImport, './excel/OSMAP Tool list.xlsx');
  // var_dump($data);
  // exit();
